...
function onUpdate()
	...
	doTweenAlpha('AlphaTween1', 'healthBarBG', 0, 0)
	doTweenAlpha('AlphaTween2', 'healthBar', 0, 0)
	doTweenAlpha('AlphaTween3', 'scoreTxt', 1, 0.25)
	doTweenAlpha('AlphaTween4', 'iconP1', 1, 0.25)
	doTweenAlpha('AlphaTween5', 'iconP2', 1, 0.25)
	doTweenAlpha('AlphaTween6', 'timeBar', 0, 0)
	doTweenAlpha('AlphaTween7', 'timeBarBG', 0, 0)
